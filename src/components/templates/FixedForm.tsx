          ...
          <div className="relative bg-white px-8 py-6 rounded-2xl shadow-lg w-[90%] sm:w-[60%] md:w-[50%] lg:w-[30%]">
            ...
            <div className="flex items-center h-8 mb-4 text-black">
              ...
              <progress value={step} max={2} className="flex-grow ml-2 h-2 bg-gray-300 rounded-full 
                ...
                [&::-moz-progress-bar]:bg-blue-500 [&::-moz-progress-bar]:rounded-full">
              </progress>
            </div>
...
const FormStep1 = ({ setStep, step1Data, setStep1Data }) => {
  ...
  return (
    <form onSubmit={handleFormStep1} className="space-y-4">
      <h2 className="text-xl font-semibold text-gray-900 mb-4">tools for Every Budget</h2>
      ...
      <div className={`flex items-center border border-gray-300 rounded-lg ${isFocused ? "ring-1 ring-blue-400" : ""}`} 
      ...
      <button className="w-full mt-4 bg-blue-500 text-black py-3 rounded-full font-semibold hover:bg-blue-600" type="submit"
...
const FormStep2 = ({ step2Data, setStep2Data }) => {
  ...
  return (
    <form onSubmit={handleFormStep2} className="space-y-4">
      ...
      <select required className="w-full p-3 border border-gray-300 rounded-lg focus:ring focus:ring-blue-400 outline-none"
        onChange={(e) => setStep2Data({ ...step2Data, propertyType: e.target.value })}>
          <option value="">Select tool Type</option>
          <option value="2BHK">op1</option>
      ...
      <select required className="w-full p-3 border border-gray-300 rounded-lg focus:ring focus:ring-blue-400 outline-none"
        onChange={(e) => setStep2Data({ ...step2Data, budget: e.target.value })}>
          ...
          <option value="5-10 lakhs"> option </option>
